...
const API = axios.create({
  baseURL: "https://fooddeliveryappbackend-5fwj.onrender.com/api",
});
...
export const addMenuItem = (id, data) =>
  API.post(`/restaurants/${id}/menu`, data);
export const updateMenuItem = (id, itemId, data) =>
  API.put(`/restaurants/${id}/menu/${itemId}`, data);
export const deleteMenuItem = (id, itemId) =>
